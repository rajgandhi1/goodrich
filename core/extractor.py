...
- isk_style: STYLE-CS = G10/G11 laminate WITH metallic core (SS316/UNS S32760/Inconel/duplex etc) — e.g. "GRE G10 laminate, Super Duplex UNS S32760 Steel core". STYLE-N = only when explicitly stated "STYLE-N"/"STYLE N" in description. TYPE-E = only when "Type E" or "(type E)" explicitly stated. TYPE-F = only when "Type F"/"(type F)" is a standalone kit-style designator. CRITICAL: "(Type-F)" or "(type F)" embedded inside a component name (e.g. "Washer & Sleeve (Type-F)", "Belleville washer (Type F)") refers to the component sub-type — set isk_style=null in those cases. NULL if none explicitly stated (do NOT default to STYLE-N). "Type F" + G10/G11 laminate + metallic core → use STYLE-CS (not TYPE-F).
